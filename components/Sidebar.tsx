...
import { MdDashboard, MdShoppingCart, MdCategory, MdHome, MdClose, MdDiscount, MdBrandingWatermark, MdSettings, MdColorLens } from 'react-icons/md';
...
const navItems = [
  ...
  { label: 'الالوان', href: '/colors', icon: MdColorLens },
